...
module.exports = function(Chart) {
	...
	helpers.getRelativePosition = function(evt, chart) {
		...
		// We divide by the current front pixel ratio, because the canvas is scaled up by that amount in each direction. However
...
// Chart.Platform implementation for targeting a front browser
module.exports = function(Chart) {
	var helpers = Chart.helpers;
