...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="card-title text-center"><h1>ویرایش نقش {{ $role->roleName }}</h1></div>
            <hr>
            <form method="POST" action="{{route('roles.update',$role->id)}}" id="formData">
                @csrf
                {{---------------------------------Role Title-------------------------------------------------}}
                <div class="form-group">
                    <label for="name">عنوان نقش</label>
                    <input type="text" class="form-control" id="roleName" name="roleName"
                           placeholder="عنوان نقش را وارد نمایید ..." value="{{$role->roleName}}">
                </div>
                <br>
                ...
                <div id="mypermission" name="mypermission">
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_all" name="permissionName[]"
                                                       value="user_all"
                                                    {{$role->permissions->contains('permissionName','user_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_insert" name="permissionName[]"
                                                       value="user_insert"
                                                    {{$role->permissions->contains('permissionName','user_insert') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_update" name="permissionName[]"
                                                       value="user_update"
                                                    {{$role->permissions->contains('permissionName','user_update') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_delete" name="permissionName[]"
                                                       value="user_delete"
                                                    {{$role->permissions->contains('permissionName','user_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_archive" name="permissionName[]"
                                                       value="user_archive"
                                                    {{$role->permissions->contains('permissionName','user_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_log_all" name="permissionName[]"
                                                       value="user_log_all"
                                                    {{$role->permissions->contains('permissions','user_log_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_log_delete" name="permissionName[]"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','user_log_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="user_log_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','user_log_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="comment_all" name="permissionName[]"
                                                       value="comment_all"
                                                    {{$role->permissions->contains('permissionName','comment_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="comment_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','comment_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="comment_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','comment_arcive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="role_all"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','role_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="role_insert"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','role_insert') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="role_update"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','role_update') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="role_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','role_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="role_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','role_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="permission_all"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','permission_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="permission_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','permission_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="article_all"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="article_insert"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_insert') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="article_update"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_update' ? 'checked' : '')}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="article_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="article_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id=articles_categories_all"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_categories_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="articles_categories_insert"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_categories_insert') ? 'checked': ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="articles_categories_update"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_categories_update') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="articles_categories_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_categories_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="articles_categories_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','article_categories_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="product_all" name="permissionName[]"
                                                       value="product_all"
                                                    {{$role->permissions->contains('permissionName','product_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="product_insert"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','product_insert') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="product_update"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','product_update') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="product_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','product_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="product_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','product_archive') ? 'checked' : ''}}>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                ...
                                                {{$role->permissions->contains('permissionName','product_categories_all') ? 'checked' : ''}}
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="products_categories_insert"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','products_categories_insert')}}>
                                                {{--                                            @endif--}}
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="products_categories_update"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','products_categories_update') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="products_categories_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','product_categories_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="products_categories_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','product_categories_archive')? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="order_all" name="permissionName[]"
                                                       value="order_all"
                                                    {{$role->permissions->contains('permissionName','order_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="order_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','order_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="order_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','order_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id=payment_all"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','payment_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="payment_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','payment_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="payment_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','payment_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="cart_all" name="permissionName[]"
                                                       value="cart_all"
                                                    {{$role->permissions->contains('permissionName','cart_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="cart_delete" name="permissionName[]"
                                                       value="cart_delete"
                                                    {{$role->permissions->contains('permissionName','cart_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="cart_archive" name="permissionName[]"
                                                       value="cart_archive"
                                                    {{$role->permissions->contains('permissionName','cart_archive') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="message_all" name="permissionName[]"
                                                       value="message_all"
                                                    {{$role->permissions->contains('permissionName','message_all') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="message_insert"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','message_insert') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="message_update"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','message_update') ? 'checked' : ''}}>
                                                {{--                                            @endif--}}
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="message_delete"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','message_delete') ? 'checked' : ''}}>
                                        ...
                                        <div class="col-md-2">
                                            <div class="icheck-material-white">
                                                <input type="checkbox" id="message_archive"
                                                    ...
                                                    {{$role->permissions->contains('permissionName','message_archive') ? 'checked' : ''}}>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description"
                                  ...
                                  placeholder="متن را وارد کنید....">{{$role->description}}</textarea>
                    </div>
                    {{---------------------------------------------------}}
                    <div class="form-group">
