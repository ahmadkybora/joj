        ...
        <div class="container">
            <div class="row">
                <div class="col d-flex flex-row">
                    <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="/front/images/phone.png" alt=""></div>+98 9392141724</div>
                    <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="/front/images/mail.png" alt=""></div><a href="#">amontazeri53@yahoo.com</a></div>
                    <div class="top_bar_content ml-auto">
                        <div class="top_bar_menu">
                            <ul class="standard_dropdown top_bar_dropdown">
                                ...
                                <li>
                                    <a href="#">تومان<i class="fas fa-chevron-down"></i></a>
                                    <ul>
                                        <li><a href="#">دلار آمریکا</a></li>
                                        <li><a href="#">یورو اروپا</a></li>
                                        <li><a href="#">درهم امارات</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="custom_dropdown">
                                        <div class="custom_dropdown_list">
                                            ...
                                            <ul class="custom_list clc">
                                                ...
                                                <li><a class="clc" href="#">کامپیوترها</a></li>
                                                <li><a class="clc" href="#">لپ تاپ ها</a></li>
                                                <li><a class="clc" href="#">دوربین</a></li>
                ...
                <div class="col">
                    ...
                    <div class="main_nav_content d-flex flex-row">
                        ...
                        <div class="cat_menu_container">
                            ...
                            <ul class="cat_menu">
                                <li><a href="#">رایانه و لپ تاپ<i class="fas fa-chevron-right ml-auto"></i></a></li>
                                <li><a href="#">دوربین و عکس<i class="fas fa-chevron-right"></i></a></li>
                                <li class="hassubs">
                                ...
                                <li><a href="#">تلفن های هوشمند و تبلت ها<i class="fas fa-chevron-right"></i></a></li>
                                <li><a href="#">تلویزیون و صدا<i class="fas fa-chevron-right"></i></a></li>
                                <li><a href="#">گجت ها<i class="fas fa-chevron-right"></i></a></li>
                                <li><a href="#">اتومبیل الکترونیکی<i class="fas fa-chevron-right"></i></a></li>
                                <li><a href="#">بازی های ویدیویی و کنسول ها<i class="fas fa-chevron-right"></i></a></li>
                        ...
                        <div class="main_nav_menu ml-auto">
                            <ul class="standard_dropdown main_nav_dropdown">
                                <li><a href="index.html">خانه<i class="fas fa-chevron-down"></i></a></li>
                                <li class="hassubs">
                ...
                <div class="col">
                    ...
                    <div class="page_menu_content">
                        ...
                        <ul class="page_menu_nav">
                            ...
                            <li class="page_menu_item"><a href="contact.html">مخاطب<i class="fa fa-angle-down"></i></a></li>
                        </ul>

                        <div class="menu_contact">
                            <div class="menu_contact_item"><div class="menu_contact_icon"><img src="/front/images/phone_white.png" alt=""></div>+98 9392141724</div>
                            <div class="menu_contact_item"><div class="menu_contact_icon"><img src="/front/images/mail_white.png" alt=""></div><a href="#">amontazeri53@yahoo.com</a></div>
                        </div>
                    </div>
                </div>
            </div>
